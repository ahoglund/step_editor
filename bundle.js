...
var _ahoglund$step_editor$Cell$init = F2(
	function (id, track_id) {
		return {id: id, track_id: track_id, is_active: false};
	});
var _ahoglund$step_editor$Cell$Cell = F3(
	function (a, b, c) {
		return {is_active: a, track_id: b, id: c};
	});

var _ahoglund$step_editor$Cmds$playRawSound = _elm_lang$core$Native_Platform.outgoingPort(
	'playRawSound',
	function (v) {
		return v;
	});
var _ahoglund$step_editor$Cmds$playSound = function (file) {
	return _ahoglund$step_editor$Cmds$playRawSound(file);
};
...
var _ahoglund$step_editor$Track$init = F4(
...
var _ahoglund$step_editor$Main$stepEditorHeader = A2(
...
var _ahoglund$step_editor$Main$toggleCell = F3(
...
var _ahoglund$step_editor$Main$stepEditorCell = F3(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_ahoglund$step_editor$Main$setActiveClass, beat.id, model.current_beat),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' ',
							A2(_ahoglund$step_editor$Main$setActiveCell, track, beat)))),
					_elm_lang$html$Html_Events$onClick(
					A2(_ahoglund$step_editor$Main$ToggleCell, track, beat))
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _ahoglund$step_editor$Main$PlaySound = function (a) {
	return {ctor: 'PlaySound', _0: a};
};
var _ahoglund$step_editor$Main$stepEditorTrack = F2(
		...
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					function (beat) {
						return A3(_ahoglund$step_editor$Main$stepEditorCell, model, track, beat);
					},
					track.cells)));
	});
var _ahoglund$step_editor$Main$stepEditorTracks = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			function (track) {
				return A2(_ahoglund$step_editor$Main$stepEditorTrack, model, track);
			},
			model.tracks));
};
var _ahoglund$step_editor$Main$stepEditor = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_ahoglund$step_editor$Main$stepEditorTableHeader(model),
				_ahoglund$step_editor$Main$stepEditorTracks(model)
			]));
};
var _ahoglund$step_editor$Main$stepEditorSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_ahoglund$step_editor$Main$stepEditorHeader,
...
var _ahoglund$step_editor$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_ahoglund$step_editor$Main$stepEditorSection(model),
				_ahoglund$step_editor$Main$buttons(model)
			]));
};
var _ahoglund$step_editor$Main$SetCurrentBeat = function (a) {
...
var _ahoglund$step_editor$Main$subscriptions = function (model) {
	...
	if (_p4 === true) {
		return A2(
			...
			_ahoglund$step_editor$Main$SetCurrentBeat);
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
};
var _ahoglund$step_editor$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _ahoglund$step_editor$Main$init, subscriptions: _ahoglund$step_editor$Main$subscriptions, update: _ahoglund$step_editor$Main$update, view: _ahoglund$step_editor$Main$view})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _ahoglund$step_editor$Main$main === 'undefined' ? null : _ahoglund$step_editor$Main$main);
